...
//  AtomVPNSDK
//
//  Copyright © 2017 AtomVPN. All rights reserved.
//
 ...
 * @discussion Invokes when the ATOM SDK is unable to connect with the provided AtomProperties.
 * @param atomConnectionDetails Provides the details of the connection attempt.
 * @param error Contains the error occured during dialing.
 */
...
/* -VPNDisconnected:manuallyDisconnected
 * @optional
 ...
 * @param manuallyDisconnected Identifying if the connection has been disconnected manually. The return value will be YES when using -cancelVPNConnection otherwise the default value will be NO.
 */
- (void)VPNDisconnected:(BOOL)manuallyDisconnected __deprecated_msg("Use -atomManagerDidDisconnect:manuallyDisconnected instead.");
 ...
 */
- (void)VPNDialedError:(NSError *)error withConnectionDetails:(AtomConnectionDetails *)atomConnectionDetails __deprecated_msg("Use -atomManagerDialErrorReceived:withConnectionDetails: instead.");
 ...
 */
+ (instancetype)sharedInstanceWithSecretKey:(NSString *)secretKey;
 ...
 * @param errorBlock The AtomProperties object used by the SDK to establish a VPN connection.
 */
 ...
 */
- (void)getOptimizeCountriesWithSuccess:(void (^)(NSArray<AtomCountry *> *success))successBlock errorBlock:(void (^)(NSError *error))errorBlock;

/*!
 * @method getCountriesWithSuccess:errorBlock
 * @discussion This function will be used to return the allowed Countries list after verifying the reseller id provided to you. AtomCountry object will be passed as the parameter to establish the VPN connections using AtomProperties object.
 ...
 */
- (void)getCountriesWithSuccess:(void (^)(NSArray<AtomCountry *> *success))successBlock errorBlock:(void (^)(NSError *error))errorBlock;
 ...
 */
- (void)getProtocolsWithSuccess:(void (^)(NSArray <AtomProtocol *> *success))successBlock errorBlock:(void (^)(NSError *error))errorBlock;
 ...
 */
- (void)getConnectionDetailsWithSuccess:(void (^)(AtomConnectionDetails *connectionDetails))successBlock errorBlock:(void (^)(NSError *error))errorBlock DEPRECATED_MSG_ATTRIBUTE("Use getLastConnectionDetailsWithSuccess instead.");
 ...
 * @param errorBlock If the connectionDetails object is returned, this parameter is set to nil. Otherwise this parameter is set to the error that occurred.
 */
- (void)getLastConnectionDetailsWithSuccess:(void (^)(AtomConnectionDetails *connectionDetails))successBlock
